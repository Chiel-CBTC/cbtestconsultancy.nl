...
## Purpose
Static legal disclaimer page at `/disclaimer`, pre-rendered at build time. Covers liability limitations, intellectual property, external links, and the right to modify content.

## Files
- `app/disclaimer/page.tsx` — static disclaimer page
